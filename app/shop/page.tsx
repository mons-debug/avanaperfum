...
function ShopPageContent() {
  ...
  useEffect(() => {
    ...
    fetchProducts();
  }, [categoryParam, genderParam, searchParam, sortParam]);
    ...
    const fetchCategories = async () => {
      try {
        ...
        if (data.success) {
          ...
          if (categoryParam) {
            const category = data.data.find((cat: Category) => 
    ...
    switch (sortBy) {
      ...
      default:
        ...
        return sortedProducts.sort((a, b) => {
          ...
          const featuredA = (a as any).featured || false;
          const featuredB = (b as any).featured || false;
